    ...
    $(document).ready(function() {
        $("#btn-delete-dentist-id-1").click(function() {
            $('#delete-dentist-id-1').modal('show');
        });
        $("#btn-delete-dentist-id-2").click(function() {
            $('#delete-dentist-id-2').modal('show');
        });
        $("#btn-delete-dentist-id-3").click(function() {
            $('#delete-dentist-id-3').modal('show');
        });
        $("#btn-delete-dentist-id-3").click(function() {
            $('#delete-dentist-id-3').modal('show');
        });
        $("#btn-delete-dentist-id-4").click(function() {
            $('#delete-dentist-id-4').modal('show');
        });
        $("#btn-delete-dentist-id-5").click(function() {
            $('#delete-dentist-id-5').modal('show');
        });
        $("#btn-delete-dentist-id-6").click(function() {
            $('#delete-dentist-id-6').modal('show');
        });
        $("#btn-delete-dentist-id-7").click(function() {
            $('#delete-dentist-id-7').modal('show');
        });
        $("#btn-delete-dentist-id-8").click(function() {
            $('#delete-dentist-id-8').modal('show');
        });
        $("#btn-delete-dentist-id-9").click(function() {
            $('#delete-dentist-id-9').modal('show');
        });
        $("#btn-delete-dentist-id-10").click(function() {
            $('#delete-dentist-id-10').modal('show');
        });
    });
    </script>
    <script type="text/javascript">
    $(document).ready(function() {
        $("#btn-delete-patient-id-1").click(function() {
            $('#delete-patient-id-1').modal('show');
        });
        $("#btn-delete-patient-id-2").click(function() {
            $('#delete-patient-id-2').modal('show');
        });
        $("#btn-delete-patient-id-3").click(function() {
            $('#delete-patient-id-3').modal('show');
        });
        $("#btn-delete-patient-id-3").click(function() {
            $('#delete-patient-id-3').modal('show');
        });
        $("#btn-delete-patient-id-4").click(function() {
            $('#delete-patient-id-4').modal('show');
        });
        $("#btn-delete-patient-id-5").click(function() {
            $('#delete-patient-id-5').modal('show');
        });
        $("#btn-delete-patient-id-6").click(function() {
            $('#delete-patient-id-6').modal('show');
        });
        $("#btn-delete-patient-id-7").click(function() {
            $('#delete-patient-id-7').modal('show');
        });
        $("#btn-delete-patient-id-8").click(function() {
            $('#delete-patient-id-8').modal('show');
        });
        $("#btn-delete-patient-id-9").click(function() {
            $('#delete-patient-id-9').modal('show');
        });
        $("#btn-delete-patient-id-10").click(function() {
            $('#delete-patient-id-10').modal('show');
        });
    });
    </script>
    <script type="text/javascript">
    $(document).ready(function() {
        $("#btn-delete-quote-id-1").click(function() {
            $('#delete-quote-id-1').modal('show');
        });
        $("#btn-delete-quote-id-2").click(function() {
            $('#delete-quote-id-2').modal('show');
        });
        $("#btn-delete-quote-id-3").click(function() {
            $('#delete-quote-id-3').modal('show');
        });
        $("#btn-delete-quote-id-3").click(function() {
            $('#delete-quote-id-3').modal('show');
        });
        $("#btn-delete-quote-id-4").click(function() {
            $('#delete-quote-id-4').modal('show');
        });
        $("#btn-delete-quote-id-5").click(function() {
            $('#delete-quote-id-5').modal('show');
        });
        $("#btn-delete-quote-id-6").click(function() {
            $('#delete-quote-id-6').modal('show');
        });
        $("#btn-delete-quote-id-7").click(function() {
            $('#delete-quote-id-7').modal('show');
        });
        $("#btn-delete-quote-id-8").click(function() {
            $('#delete-quote-id-8').modal('show');
        });
        $("#btn-delete-quote-id-9").click(function() {
            $('#delete-quote-id-9').modal('show');
        });
        $("#btn-delete-quote-id-10").click(function() {
            $('#delete-quote-id-10').modal('show');
        });
    });
    </script>
    <script type="text/javascript">
    $(document).ready(function() {
        $("#btn-delete-review-id-1").click(function() {
            $('#delete-review-id-1').modal('show');
        });
        $("#btn-delete-review-id-2").click(function() {
            $('#delete-review-id-2').modal('show');
        });
        $("#btn-delete-review-id-3").click(function() {
            $('#delete-review-id-3').modal('show');
        });
        $("#btn-delete-review-id-3").click(function() {
            $('#delete-review-id-3').modal('show');
        });
        $("#btn-delete-review-id-4").click(function() {
            $('#delete-review-id-4').modal('show');
        });
        $("#btn-delete-review-id-5").click(function() {
            $('#delete-review-id-5').modal('show');
        });
        $("#btn-delete-review-id-6").click(function() {
            $('#delete-review-id-6').modal('show');
        });
        $("#btn-delete-review-id-7").click(function() {
            $('#delete-review-id-7').modal('show');
        });
        $("#btn-delete-review-id-8").click(function() {
            $('#delete-review-id-8').modal('show');
        });
        $("#btn-delete-review-id-9").click(function() {
            $('#delete-review-id-9').modal('show');
        });
        $("#btn-delete-review-id-10").click(function() {
            $('#delete-review-id-10').modal('show');
        });
    });
    </script>