        ...
        <aside class="right-side">
            <div class="row-top">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Upit pacijenta</li>
                </ul>
                <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body col-md-8">
                            <form role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputDate" placeholder="dd-mm-yyyy">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputQuoteTitle">Naslov oglasa</label>
                                    <input type="text" class="form-control" id="exampleInputQuoteTitle" placeholder="Naslov oglasa">
                                </div>
                                <div class="form-group">
