 ...
 <ul class="breadcrumb">
    ...
    <li class="active"><a href="{{ URL::route('QuoteIndex') }}">Pregled svih upita</a></li>
    
    <a href="{{ URL::route('QuoteCreate') }}" class="pull-right" style="margin-top: -5px;">
        <button class="btn btn-success btn-addon btn-sm">
            <i class="fa fa-plus"></i> Dodaj novi upit
        </button>
    </a>
</ul>
        
<div class="panel-heading">
    <h4>Pregled svih upita</h4>
</div>
             ...
             @if (count($entries['entries']) > 0) 
                ...
                <tr>
                    ...
                    <td class="col-md-1">
                        ...
                        <a href="{{ URL::route('QuoteEdit', array('id' => $entry->id)) }}">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="{{ URL::route('QuoteDestroy', array('id' => $entry->id)) }}">
