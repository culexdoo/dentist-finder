 ...
 <ul class="breadcrumb">
    ...
    <li class="active"><a href="{{ URL::route('ReviewIndex') }}">Pregled svih recenzija</a></li>
    
    <a href="{{ URL::route('ReviewCreate') }}" class="pull-right" style="margin-top: -5px;">
                ...
                <tr>
                    ...
                    <td>
                        @if ($entry->image != '' || $entry->image != null)
                            <img src="{{ url('/') }}/uploads/frontend/review/{{ $entry->image }}" class="review-post-image img-responsive" />
                        @endif 
                    </td>
                    <td>{{ $entry->intro }}</td>
                    <td>{{ $entry->status }}</td>
