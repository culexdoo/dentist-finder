            ...
            <div class="row-top">
                ...
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Uredi pacijenta</li>
                    </ul>
                    <!-- /breadcrumbs -->
                    ...
                    <div class="col-md-6">
                            ...
                            <div class="panel-body">
                                <form role="form">
                                    ...
                                    <label for="examplePointedOut">Istaknuto:</label>
                                        ...
                                        <div class="form-group">
                                            <label>OIB</label>
                                            <input type="text" class="form-control" id="exampleInputEmail" placeholder="OIB">
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="panel-body">
                        <div class="col-md-12">
                        <!-- Donji lijevi dio, pacijentova povijest -->
                        <label for="exampleInputNotes">Bilješka o pacijentu:</label>
                        <textarea style="width:100%; height: auto; border: 1px solid #CCC; border-radius: 5px;"> </textarea>
                        ...
                        <section class="panel">
                            <div class="panel-body">
                                ...
                                <label for="exampleInputData">Podaci o pacijentu:</label>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputKontaktMob1">Kontakt Tel 1</label>
                                        <input type="email" class="form-control" id="exampleInputKontaktMob1" placeholder="KontaktMob1">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputKontaktMob2">Kontakt Tel 2</label>
