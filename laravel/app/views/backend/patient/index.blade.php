 ...
 <ul class="breadcrumb">
    ...
    <li class="active"><a href="{{ URL::route('PatientIndex') }}">Pregled svih pacijenata</a></li>
    
    <a href="{{ URL::route('PatientCreate') }}" class="pull-right" style="margin-top: -5px;">
             ...
             @if (count($entries['entries']) > 0) 
                ...
                <tr>
                    ...
                    <td class="col-md-1">
                        ...
                        <a href="{{ URL::route('PatientEdit', array('id' => $entry->id)) }}">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="{{ URL::route('PatientDestroy', array('id' => $entry->id)) }}">
