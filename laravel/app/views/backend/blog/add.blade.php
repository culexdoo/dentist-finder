                        ...
                        <div class="panel-body col-md-8">
                            <form role="form">
                                <div class="form-group">
                                    <label for="exampleInputTitle">Naslov</label>
                                    <input type="text" class="form-control" id="exampleInputName" value="Nove tehnike za brušenje zubi">
                                </div> 
                                <div class="form-group">
                                    <label for="exampleInputShortDescription">Kratki opis</label>
                                    <div class="textarea">
                                        <textarea style="width:100%; min-height: 100px; border: 1px solid #CCC; border-radius: 5px;"> </textarea>
                                    </div>
                                </div> 
                                <div class="form-group">
                                    <label for="exampleInputShortDescription">Dugi opis</label>
                                    <div class="textarea">
